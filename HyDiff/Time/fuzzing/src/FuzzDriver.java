     ...
     private static String address ="/home/amirfarhad/Desktop/ProgramAnalysis/codes/GSoC_Fuzzer_RAC_GitHub/HyDiff/Time/jml";
     private static String addressPost ="/home/amirfarhad/Desktop/ProgramAnalysis/codes/GSoC_Fuzzer_RAC_GitHub/HyDiff/Time/jmlPost"; 
     public static void main(String args[]) {
		...
		boolean precondition = RunRAC(constructor, select, hour, minute, second, start_h, start_m, start_s, stop_h, stop_m, stop_s, flag);

		if (precondition) {
			flag = true;
			boolean postcondition = RunRAC(constructor, select, hour, minute, second, start_h, start_m, start_s, stop_h, stop_m, stop_s, flag);
	 ...
	 public static boolean RunRAC(int constructor, int select, int hour, int minute, int second, int start_h, int start_m, int start_s, int stop_h, int stop_m, int stop_s, boolean flag) {
